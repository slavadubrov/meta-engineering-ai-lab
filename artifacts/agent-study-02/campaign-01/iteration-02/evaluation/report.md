...
| Local p50 latency (ms) | 0.0473 | 0.0465 | 0.0574 |
| Local p95 latency (ms) | 0.2117 | 0.2948 | 0.2279 |
...
Enabling deduplication will reuse identical active values instead of appending redundant records, preserving successful retrieval while reducing storage records and bytes.
...
uv run --frozen python -m lab verify artifacts/agent-study-02/campaign-01/iteration-02/evaluation
```
