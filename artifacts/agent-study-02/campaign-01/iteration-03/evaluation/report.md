...
| Local p50 latency (ms) | 0.0473 | 0.0465 | 0.0574 | 0.0545 |
| Local p95 latency (ms) | 0.2117 | 0.2948 | 0.2279 | 0.2258 |
...
Lowering min_confidence from 0.7 to 0.6 will admit the observed useful borderline fact while continuing to reject the observed low-confidence unnecessary fact.
...
uv run --frozen python -m lab verify artifacts/agent-study-02/campaign-01/iteration-03/evaluation
```
