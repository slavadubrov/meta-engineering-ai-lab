...
Release: `baseline`. Source SHA-256: `961aa593955873e4cfae672fb56286e599f587cc2ebdcca57f0bb6ffd709649f`.
...
| Local p50 latency (ms) | 0.1249 |
| Local p95 latency (ms) | 0.5047 |
...
uv run --frozen python -m lab verify artifacts/agent-study-02/campaign-02/baseline
```
