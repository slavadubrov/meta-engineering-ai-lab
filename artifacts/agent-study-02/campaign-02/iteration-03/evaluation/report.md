...
| Local p50 latency (ms) | 0.1249 | 0.0617 | 0.0580 | 0.0541 |
| Local p95 latency (ms) | 0.5047 | 0.2474 | 0.3405 | 0.2070 |
...
Lowering min_confidence to 0.6 will admit the demonstrated useful fact while continuing to reject the 0.3 and 0.4 low-quality facts.
...
uv run --frozen python -m lab verify artifacts/agent-study-02/campaign-02/iteration-03/evaluation
```
