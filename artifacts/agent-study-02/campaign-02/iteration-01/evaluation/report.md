...
| Local p50 latency (ms) | 0.1249 | 0.0617 |
| Local p95 latency (ms) | 0.5047 | 0.2474 |
...
uv run --frozen python -m lab verify artifacts/agent-study-02/campaign-02/iteration-01/evaluation
```
