...
| Local p50 latency (ms) | 0.1315 | 0.0609 |
| Local p95 latency (ms) | 0.8612 | 0.2428 |
...
uv run --frozen python -m lab verify artifacts/agent-study-02/campaign-03/iteration-01/evaluation
```
