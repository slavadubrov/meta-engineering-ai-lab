...
Release: `baseline`. Source SHA-256: `e29a92de7497dff9e97d07de7aba37ebf30c26f9d7c55ec8f515dced8ce0418a`.
...
| Mean stored bytes (bytes) | 532.55 |
| Local p50 latency (ms) | 0.0665 |
| Local p95 latency (ms) | 0.2185 |
...
uv run --frozen python -m lab verify artifacts/agent-study-03/campaign-01/baseline
```
