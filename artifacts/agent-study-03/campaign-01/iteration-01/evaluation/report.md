...
| Local p50 latency (ms) | 0.0665 | 0.0677 |
| Local p95 latency (ms) | 0.2185 | 0.2349 |
...
uv run --frozen python -m lab verify artifacts/agent-study-03/campaign-01/iteration-01/evaluation
```
