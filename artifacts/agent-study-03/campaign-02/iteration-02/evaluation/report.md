...
| Local p50 latency (ms) | 0.2010 | 0.1083 | 0.0665 |
| Local p95 latency (ms) | 0.7843 | 0.3283 | 0.2308 |
...
Enabling entity and temporal filtering will remove cross-entity distractors and exclude records outside the requested as-of interval, while deduplication can reduce repeated identical facts without changing answers.
...
Enabling deduplication will reuse identical active values confirmed on later effective dates, preserving retrieval answers while reducing redundant stored records.
...
uv run --frozen python -m lab verify artifacts/agent-study-03/campaign-02/iteration-02/evaluation
```
