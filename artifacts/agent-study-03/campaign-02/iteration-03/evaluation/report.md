...
| Local p50 latency (ms) | 0.2010 | 0.1083 | 0.0665 | 0.0742 |
| Local p95 latency (ms) | 0.7843 | 0.3283 | 0.2308 | 0.2379 |
...
Lowering min_confidence from 0.7 to 0.6 will admit the demonstrated useful low-confidence fact while preserving the shown abstentions for scores 0.3 and 0.4.
...
uv run --frozen python -m lab verify artifacts/agent-study-03/campaign-02/iteration-03/evaluation
```
