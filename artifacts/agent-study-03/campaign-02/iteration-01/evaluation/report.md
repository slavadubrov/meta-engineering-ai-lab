...
| Local p50 latency (ms) | 0.2010 | 0.1083 |
| Local p95 latency (ms) | 0.7843 | 0.3283 |
...
uv run --frozen python -m lab verify artifacts/agent-study-03/campaign-02/iteration-01/evaluation
```
