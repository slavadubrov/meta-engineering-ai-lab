...
| Mean stored bytes (bytes) | 532.55 | 532.55 |
| Local p50 latency (ms) | 0.1163 | 0.0833 |
| Local p95 latency (ms) | 0.8706 | 0.3543 |
...
uv run --frozen python -m lab verify artifacts/agent-study-03/campaign-03/iteration-01/evaluation
```
