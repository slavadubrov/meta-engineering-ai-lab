...
| Local p50 latency (ms) | 0.1163 | 0.0833 | 0.0683 | 0.0744 |
| Local p95 latency (ms) | 0.8706 | 0.3543 | 0.2410 | 0.2585 |
...
Lowering min_confidence from 0.7 to 0.6 will admit the useful low-confidence fact while continuing to reject the demonstrated 0.3 and 0.4 low-confidence writes, improving complete-scenario success without changing retrieval behavior or duplication efficiency.
...
uv run --frozen python -m lab verify artifacts/agent-study-03/campaign-03/iteration-03/evaluation
```
