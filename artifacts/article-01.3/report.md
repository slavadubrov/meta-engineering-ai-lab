...
Release: `article-01.3`. Source SHA-256: `29578c8fbccf22e6fc5686aa771b355d9ca3eb03496691ba5bd2978c88d57ef6`.
...
| Local p50 latency (ms) | 0.0471 | 0.0458 | 0.0446 | 0.0465 |
| Local p95 latency (ms) | 0.2975 | 0.1719 | 0.1741 | 0.2555 |
...
uv run --frozen python -m lab verify artifacts/article-01.3
```
