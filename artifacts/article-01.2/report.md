...
Release: `article-01.2`. Source SHA-256: `1b39a1cc9c6493a216a982d608b14fd3ecf8336eb526dfe43965e21bfbbc49de`.
...
| Local p50 latency (ms) | 0.0488 | 0.0477 | 0.0482 | 0.0481 |
| Local p95 latency (ms) | 0.2173 | 0.1935 | 0.3034 | 0.1873 |
...
uv run --frozen python -m lab verify artifacts/article-01.2
```
