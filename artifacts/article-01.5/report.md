...
Release: `article-01.5`. Source SHA-256: `961aa593955873e4cfae672fb56286e599f587cc2ebdcca57f0bb6ffd709649f`.
...
| Local p50 latency (ms) | 0.0582 | 0.0437 | 0.0448 | 0.0466 |
| Local p95 latency (ms) | 0.4175 | 0.1732 | 0.1784 | 0.1698 |
...
uv run --frozen python -m lab verify artifacts/article-01.5
```
