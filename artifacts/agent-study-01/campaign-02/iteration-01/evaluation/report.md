...
| Local p50 latency (ms) | 0.0428 | 0.0601 |
| Local p95 latency (ms) | 0.1765 | 0.2486 |
...
uv run --frozen python -m lab verify artifacts/agent-study-01/campaign-02/iteration-01/evaluation
```
