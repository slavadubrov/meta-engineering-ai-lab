...
| Local p50 latency (ms) | 0.0428 | 0.0601 | 0.0581 | 0.0547 |
| Local p95 latency (ms) | 0.1765 | 0.2486 | 0.2234 | 0.1981 |
...
Lowering min_confidence from 0.7 to 0.6 will admit the useful Portuguese fact while continuing to reject the 0.3-confidence unwanted fact, improving complete-scenario success without changing retrieval isolation or filtering.
...
uv run --frozen python -m lab verify artifacts/agent-study-01/campaign-02/iteration-04/evaluation
```
