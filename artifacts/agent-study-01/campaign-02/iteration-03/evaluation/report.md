...
| Local p50 latency (ms) | 0.0428 | 0.0601 | 0.0581 |
| Local p95 latency (ms) | 0.1765 | 0.2486 | 0.2234 |
...
Enabling entity and validity-date filtering will remove cross-entity distractors and exclude records outside the requested as-of interval, improving complete-scenario task success without changing write admission or hard-constraint behavior.
...
Enabling deduplication will reuse identical active values during repeated confirmations, reducing stored records without changing retrieval answers or write admission.
...
uv run --frozen python -m lab verify artifacts/agent-study-01/campaign-02/iteration-03/evaluation
```
