...
Release: `baseline`. Source SHA-256: `7539cf5b28925c0842fd322b563426c27338150d4c585d98f18ba26836fe953e`.
...
| Local p50 latency (ms) | 0.0428 |
| Local p95 latency (ms) | 0.1765 |
...
uv run --frozen python -m lab verify artifacts/agent-study-01/campaign-02/baseline
```
