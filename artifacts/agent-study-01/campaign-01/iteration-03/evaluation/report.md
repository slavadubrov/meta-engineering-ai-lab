...
Release: `evaluation`. Source SHA-256: `7539cf5b28925c0842fd322b563426c27338150d4c585d98f18ba26836fe953e`.

| Metric | Baseline | Agent proposal 1 | Agent proposal 3 |
| --- | ---: | ---: | ---: |
| Downstream success (fraction) | 65.0% | 95.0% | 95.0% |
| Useful-write precision (fraction) | 100.0% | 100.0% | 100.0% |
| Useful-write recall (fraction) | 97.4% | 97.4% | 97.4% |
| Unnecessary-write rate (fraction) | 0.0% | 0.0% | 0.0% |
| Relevant-memory recall (fraction) | 90.5% | 95.2% | 95.2% |
| Distracting-memory rate (fraction) | 48.6% | 4.8% | 4.8% |
| Stale/future fact rate (fraction) | 14.8% | 0.0% | 0.0% |
| Update correctness (fraction) | 100.0% | 100.0% | 100.0% |
| Mean context words (words) | 4.11 | 2.33 | 2.33 |
| Mean stored records (records) | 1.70 | 1.70 | 1.60 |
| Mean stored bytes (bytes) | 416.35 | 416.35 | 390.45 |
| Local p50 latency (ms) | 0.0468 | 0.0458 | 0.0556 |
| Local p95 latency (ms) | 0.2075 | 0.3019 | 0.2685 |
| Provider expenditure (USD) | 0.00 | 0.00 | 0.00 |
| Model tokens (tokens) | 0.00 | 0.00 | 0.00 |
...
Enabling entity and temporal pre-filters will prevent cross-entity distractors and exclude records outside the requested as-of interval, improving complete-scenario task success and reducing stale or distracting retrieval without changing writes or hard-constraint behavior.
...
Enabling deduplication will reuse identical active values during repeated confirmations, preserving retrieval correctness while reducing unnecessary historical records and storage.
...
uv run --frozen python -m lab verify artifacts/agent-study-01/campaign-01/iteration-03/evaluation
```
