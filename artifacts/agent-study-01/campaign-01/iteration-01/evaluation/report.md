...
| Local p50 latency (ms) | 0.0468 | 0.0458 |
| Local p95 latency (ms) | 0.2075 | 0.3019 |
...
uv run --frozen python -m lab verify artifacts/agent-study-01/campaign-01/iteration-01/evaluation
```
