...
| Local p50 latency (ms) | 0.0423 | 0.0593 |
| Local p95 latency (ms) | 0.2025 | 0.2293 |
...
uv run --frozen python -m lab verify artifacts/agent-study-01/campaign-03/iteration-01/evaluation
```
