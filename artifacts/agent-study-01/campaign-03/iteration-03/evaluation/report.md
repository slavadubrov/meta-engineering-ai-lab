...
| Local p50 latency (ms) | 0.0423 | 0.0593 | 0.0535 | 0.0548 |
| Local p95 latency (ms) | 0.2025 | 0.2293 | 0.2062 | 0.2156 |
...
Lowering min_confidence from 0.7 to 0.6 will admit the demonstrated useful low-confidence fact while preserving abstention for the 0.3 and 0.4 cases, improving complete-scenario success without changing retrieval isolation or deduplication behavior.
...
uv run --frozen python -m lab verify artifacts/agent-study-01/campaign-03/iteration-03/evaluation
```
