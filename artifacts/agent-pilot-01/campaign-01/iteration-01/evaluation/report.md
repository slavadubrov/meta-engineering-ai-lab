...
Release: `evaluation`. Source SHA-256: `255f603c37fa48be82b4c94154c6c654243672245632b15bc4baf213dd83fba0`.
...
| Local p50 latency (ms) | 0.0471 | 0.0437 |
| Local p95 latency (ms) | 0.1722 | 0.2873 |
...
Enabling entity and as-of-date filtering will prevent cross-entity distractors and exclude records outside the requested validity interval, improving complete-scenario task success without changing write admission or hard-constraint behavior.
...
uv run --frozen python -m lab verify artifacts/agent-pilot-01/campaign-01/iteration-01/evaluation
```
