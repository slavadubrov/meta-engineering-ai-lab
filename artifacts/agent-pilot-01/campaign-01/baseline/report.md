...
Release: `baseline`. Source SHA-256: `255f603c37fa48be82b4c94154c6c654243672245632b15bc4baf213dd83fba0`.

| Metric | Baseline |
| --- | ---: |
| Downstream success (fraction) | 65.0% |
| Useful-write precision (fraction) | 100.0% |
| Useful-write recall (fraction) | 97.4% |
| Unnecessary-write rate (fraction) | 0.0% |
| Relevant-memory recall (fraction) | 90.5% |
| Distracting-memory rate (fraction) | 48.6% |
| Stale/future fact rate (fraction) | 14.8% |
| Update correctness (fraction) | 100.0% |
| Mean context words (words) | 4.11 |
| Mean stored records (records) | 1.70 |
| Mean stored bytes (bytes) | 416.35 |
| Local p50 latency (ms) | 0.0473 |
| Local p95 latency (ms) | 0.1732 |
| Provider expenditure (USD) | 0.00 |
| Model tokens (tokens) | 0.00 |
...
uv run --frozen python -m lab verify artifacts/agent-pilot-01/campaign-01/baseline
```
