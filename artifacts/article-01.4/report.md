...
Release: `article-01.4`. Source SHA-256: `7539cf5b28925c0842fd322b563426c27338150d4c585d98f18ba26836fe953e`.
...
| Local p50 latency (ms) | 0.0480 | 0.0447 | 0.0469 | 0.0508 |
| Local p95 latency (ms) | 0.3070 | 0.1840 | 0.1787 | 0.1978 |
...
uv run --frozen python -m lab verify artifacts/article-01.4
```
