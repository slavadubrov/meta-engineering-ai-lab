# The deterministic memory component
...
See the [readable comparison report](../reports/article-01.6.md) and
exact counts in the downloaded `artifacts/article-01.6/bundle.json` under each
...
Open the **saved experiment** in the browser. Download the evidence once; it can coexist with your fresh local runs in `artifacts/`. Skip the download if the recordings are already present:
...
| `artifacts/article-01.6/` | Downloaded measured evidence; ignored by Git              |
